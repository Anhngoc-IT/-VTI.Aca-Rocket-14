...
CREATE TABLE IF NOT EXISTS Gruop_Account(
    ...
    CONSTRAINT PK_Gruop_Account PRIMARY KEY (Gruop_id),
    CONSTRAINT FK_Gruop_Account FOREIGN KEY (Account_id) REFERENCES Account (Account_id)
);
...
VALUES ('1', '01', 'Test Finally', '001', '15', '111', '2000-09-07');

INSERT INTO Exam (Exam_id, Code, Title, Category_id, Duration, Creator_id, Create_Date) 
VALUES ('2', '02', 'Test Midterm', '002', '16', '112', '2010-01-07');

INSERT INTO Exam (Exam_id, Code, Title, Category_id, Duration, Creator_id, Create_Date) 
VALUES ('3', '03', 'Test Math', '003', '17', '113', '2020-06-03');

INSERT INTO Exam (Exam_id, Code, Title, Category_id, Duration, Creator_id, Create_Date) 
VALUES ('4', '04', 'Test Literature', '004', '18', '114', '2019-05-05');

INSERT INTO Exam (Exam_id, Code, Title, Category_id, Duration, Creator_id, Create_Date) 
VALUES ('5', '05', 'Test Chemical', '005', '19', '115', '2021-09-05');
